...
public class CWE119_125_787_Test extends IntegrationTestBase {
    ...
    public void test_ARM32LE() throws Exception {
        ...
        context context = com.bai.env.context.getContext(GlobalState.flatAPI.getFunctionAt(GlobalState.flatAPI.toAddr(0x104c4)))
                .get(0);
        ...
        context = com.bai.env.context.getContext(GlobalState.flatAPI.getFunctionAt(GlobalState.flatAPI.toAddr(0x10528))).get(0);
        ...
        context = com.bai.env.context.getContext(GlobalState.flatAPI.getFunctionAt(GlobalState.flatAPI.toAddr(0x105a0))).get(0);
    ...
    public void test_AARCH64LE() throws Exception {
        ...
        context context = com.bai.env.context.getContext(GlobalState.flatAPI.getFunctionAt(GlobalState.flatAPI.toAddr(0x1008e8)))
                .get(0);
        ...
        context = com.bai.env.context.getContext(GlobalState.flatAPI.getFunctionAt(GlobalState.flatAPI.toAddr(0x100894))).get(0);
        ...
        context = com.bai.env.context.getContext(GlobalState.flatAPI.getGlobalFunctions("main").get(0)).get(0);
        expect = new CWEReport(MemoryCorruption.CWE119, "", "").setContext(context).setAddress(address);
        assert cweReportMap.containsKey(expect);
    }
    ...
    public void test_X86_64() throws Exception {
        ...
        context context = com.bai.env.context.getContext(GlobalState.flatAPI.getFunctionAt(GlobalState.flatAPI.toAddr(0x401166)))
                .get(0);
        CWEReport expect = new CWEReport(MemoryCorruption.CWE787, "", "").setContext(context).setAddress(address);
        assert cweReportMap.containsKey(expect);

        address = GlobalState.flatAPI.toAddr(0x4011d1);
        context = com.bai.env.context.getContext(GlobalState.flatAPI.getFunctionAt(GlobalState.flatAPI.toAddr(0x4011a1))).get(0);
        expect = new CWEReport(MemoryCorruption.CWE125, "", "").setContext(context).setAddress(address);
        assert cweReportMap.containsKey(expect);
    ...
    public void test_X86_32() throws Exception {
        ...
        context context = com.bai.env.context.getContext(GlobalState.flatAPI.getFunctionAt(GlobalState.flatAPI.toAddr(0x1122d)))
                .get(0);
        CWEReport expect = new CWEReport(MemoryCorruption.CWE787, "", "").setContext(context).setAddress(address);
        assert cweReportMap.containsKey(expect);

        address = GlobalState.flatAPI.toAddr(0x1129b);
        context = com.bai.env.context.getContext(GlobalState.flatAPI.getFunctionAt(GlobalState.flatAPI.toAddr(0x1126b))).get(0);
        expect = new CWEReport(MemoryCorruption.CWE125, "", "").setContext(context).setAddress(address);
        assert cweReportMap.containsKey(expect);

        address = GlobalState.flatAPI.toAddr(0x1133a);
        context = com.bai.env.context.getContext(GlobalState.flatAPI.getFunctionAt(GlobalState.flatAPI.toAddr(0x112c7))).get(0);
        expect = new CWEReport(MemoryCorruption.CWE119, "", "").setContext(context).setAddress(address);
        assert cweReportMap.containsKey(expect);
    }
